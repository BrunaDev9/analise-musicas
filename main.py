...
# 1. Vamos agrupar por gênero e calcular a média de Dançabilidade e Energia
resumo_generos = df.groupby('track_genre')[['danceability', 'energy']].mean().reset_index()

# 2. Vamos ordenar para ver os 10 mais "dançáveis"
...
# 3. Vamos ver a média geral de Energia de todo o arquivo
media_energia = df['energy'].mean()
print(f"\nA energia média de todas as músicas é: {media_energia:.2f}")
import plotly.express as px

# Criando um gráfico de barras com os 10 mais dançáveis
...
# Isso vai abrir uma aba no seu navegador com o gráfico!
fig.show()